...
class Diler(models.Model):
    ...
    organization = models.CharField(max_length=200, default='',blank=True, verbose_name='Организация')
    warehouse_address = models.CharField(max_length=200, default='',blank=True, verbose_name='Адрес склада')
...
class Provider(models.Model):
    ...
    company = models.CharField(max_length=200, default='', blank=True, verbose_name='Компания')
    legal_entity = models.CharField(max_length=200, default='', blank=True, verbose_name='Юридическое лицо')
    product_address = models.CharField(max_length=200, default='', blank=True, verbose_name='Адрес производства')
    contact_entity = models.CharField(max_length=200, default='', blank=True, verbose_name='Руководитель')
    contact_phone = models.CharField(default='', max_length=20, blank=True, verbose_name='Телефон производства')
    service_entity = models.CharField(max_length=200, default='', blank=True, verbose_name='Менеджер')
    service_phone = models.CharField(default='',max_length=20, blank=True, verbose_name='Контактный телефон')
    service_email = models.EmailField(default='', blank=True, verbose_name='E-mail')
